...
namespace BlogsApp.Controllers
{
    public class BlogsController : Controller
    {
        ...
        {
            return View("Index", await _context.Blog.Where(j => j.Title.Contains(SearchPhrase) || j.Author.Contains(SearchPhrase) || j.Content.Contains(SearchPhrase)).ToListAsync());
        }
